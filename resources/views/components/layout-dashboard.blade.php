            ...
            <div class="w-1/2 pr-0">
                <div class="flex relative inline-block float-right">
                    <div class="relative text-sm">
                        <button @click="showUserMenu = !showUserMenu" class="flex items-center focus:outline-none mr-3">
                    ...
                    <div class="block lg:hidden pr-4">
                        <button @click="showMainMenu = !showMainMenu" class="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-gray-900 hover:border-teal-500 appearance-none focus:outline-none">
